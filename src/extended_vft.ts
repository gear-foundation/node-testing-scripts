...
import { TransactionBuilder, ActorId, NonZeroU256, getServiceNamePrefix, getFnNamePrefix, ZERO_ADDRESS } from 'sails-js';
...
export class Vft {
  ...
  public async balances(originAddress?: string, value?: number | string | bigint, atBlock?: `0x${string}`): Promise<Array<[ActorId, NonZeroU256]>> {
    ...
    return result[2].toJSON() as unknown as Array<[ActorId, NonZeroU256]>;
  }
